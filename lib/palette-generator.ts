import { oklch, formatHex, wcagContrast, Oklch, modeOklch, useMode } from "culori";
...
export function getAccessibleBaseStep(
  ramp: Record<ColorStep, string>,
  startStep: ColorStep,
): { bgStep: ColorStep; textToken: string; textHex: string } {
