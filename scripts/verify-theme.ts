...
try {
    ...
    console.log(`Closest Step ${brandGen.closestStep}: ${brandGen.ramp[brandGen.closestStep]} (Seed: ${brandSeed})`);
    ...
    if (theme.theme.interactive.brand.rest.$value === `{color.brand.${brandGen.closestStep}}`) {
        console.log("✅ Mirror Logic Verified: Interactive Brand Rest aliases dynamically to closestStep.");
    } else {
