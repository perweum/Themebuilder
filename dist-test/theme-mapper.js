...
function mapTheme(themeColors, neutralGen, successGen, errorGen, semanticOverrides) {
    ...
    themeColors.forEach((config) => {
        ...
        theme.text[cName] = {
            ...
            onSurface: { $value: `{color.${cName}.${(0, palette_generator_1.getAccessibleForeground)(gen.ramp, gen.ramp[100])}}`, $type: "color" },
            onInteractive: { $value: `{color.${cName}.${(0, palette_generator_1.getAccessibleForeground)(gen.ramp, gen.ramp[rest])}}`, $type: "color" },
        };
        theme.icon[cName] = {
        ...
        darkTheme.text[cName] = {
            ...
            onSurface: { $value: `{color.${cName}.${(0, palette_generator_1.getAccessibleForeground)(gen.ramp, gen.ramp[800])}}`, $type: "color" },
            onInteractive: { $value: `{color.${cName}.${(0, palette_generator_1.getAccessibleForeground)(gen.ramp, gen.ramp[400])}}`, $type: "color" },
        };
