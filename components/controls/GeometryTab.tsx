    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', flex: 1, gap: '1.5rem' }}>
            {themes.map((theme) => {
                ...
                return (
                    <div key={`geo-${theme.id}`} style={{ border: 'none', borderRadius: '8px', padding: '1.5rem', backgroundColor: isDarkMode ? '#1a1a1a' : '#f9fafb' }}>
                        <div style={group}>
                        ...
                        <div style={{ marginTop: '2rem' }}>
                            ...
                            <div style={group}>
                                <label style={{ ...label, display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer', textTransform: 'none' }}>
                                    <input
                                        type="checkbox"
                                ...
                                <label style={{ ...label, marginTop: '0.5rem', opacity: geometry.includeRadius ? 1 : 0.5 }}>Radius Base (px)</label>
                                <input
                                    type="number"
                                    min="0"
                                    max="64"
                            ...
                            {geometry.includeBorders && (
                                <div style={group}>
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => updateThemeGeometryValue(theme.id, 'borderWidth', e.target.value as any)}
