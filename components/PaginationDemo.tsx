...
export const PaginationDemo: React.FC<DemoProps> = ({
    ...
    return (
      <button
        ...
        style={{
          ...
          border: isCurrent
            ? `var(--geometry-borderWidth-default, 1px) solid var(--color-border-${accentColorName}-default)`
            : "var(--geometry-borderWidth-default, 1px) solid var(--color-border-subtle)",
          background: isCurrent
            ? `var(--color-surface-${accentColorName}-default)`
            : "var(--color-surface-default)",
          color: isCurrent
            ? `var(--color-text-${accentColorName}-default)`
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          background: "var(--color-surface-default)",
          color:
            currentPage === totalPages ? "var(--color-text-disabled)" : "var(--color-text-default)",
