...
import { Select as AriaSelect, SelectProps as AriaSelectProps, Label, Button, SelectValue, Popover, ListBox, ListBoxItem, SelectRenderProps } from 'react-aria-components';
...
export function Select<T extends object>({
    ...
    return (
        <AriaSelect {...props} style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
            {label && <Label style={{ fontSize: '0.875rem', fontWeight: 600, color: 'var(--color-text-subtle)' }}>{label}</Label>}
