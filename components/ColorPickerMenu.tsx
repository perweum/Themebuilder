    ...
    <DialogTrigger onOpenChange={handleOpenChange}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          />
          <span style={{ fontSize: "0.875rem", fontFamily: "inherit", fontWeight: 500 }}>
            {seed}
          </span>
        </div>
        <Pencil
          ...
          size={14}
          strokeWidth={2}
          style={{ color: isDarkMode ? "#8892b0" : "#64748b" }}
        />
      </Button>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                  ...
                  {existingColors.length > 0 && (
                    ...
                    >
                      ...
                      >
                        Velg fra eksisterende paletter
                      </Label>
                      <div
                        style={{
                          display: "grid",
                        ...
                        {existingColors.map((c) => (
                          <div
                            ...
                            style={{
                              ...
                              outline:
                                tempSeed.toLowerCase() === c.seed.toLowerCase()
