...
export const TestThemeWebsite: React.FC<{
  isDarkMode: boolean;
  activeTheme: ThemeConfig;
  onClose: () => void;
  onToggleTheme: () => void;
}> = ({ isDarkMode, activeTheme, onClose, onToggleTheme }) => {
  const primaryColorName =
    activeTheme.colors[0]?.name.toLowerCase().replace(/\s+/g, "-") || "brand";
  const secondaryColorName =
    activeTheme.colors[1]?.name.toLowerCase().replace(/\s+/g, "-") || primaryColorName;
  ...
  const FeatureData = [
    {
      icon: <ShieldCheck size={32} color={tColor(`color-base-${secondaryColorName}-default`)} />,
      title: "Enterprise Security",
      desc: "Bank-grade encryption protecting your data at rest and in transit.",
    },
    {
      icon: <Zap size={32} color={tColor(`color-base-${secondaryColorName}-default`)} />,
      title: "Lightning Fast",
      desc: "Global CDN distribution ensures sub-second load times anywhere.",
    },
    {
      icon: (
        <LayoutDashboard size={32} color={tColor(`color-base-${secondaryColorName}-default`)} />
      ),
      title: "Intuitive Dashboard",
      desc: "No learning curve. Beautiful interfaces designed for humans.",
    },
    {
      icon: <Database size={32} color={tColor(`color-base-${secondaryColorName}-default`)} />,
      title: "Infinite Scaling",
      desc: "Our architecture grows with you. From 10 to 10M users.",
    },
    {
      icon: <Smartphone size={32} color={tColor(`color-base-${secondaryColorName}-default`)} />,
      title: "Mobile Native",
      desc: "Flawless experiences across all devices and screen sizes.",
    },
    {
      icon: <ArrowRight size={32} color={tColor(`color-base-${primaryColorName}-default`)} />,
      title: "API Driven",
      desc: "Integrate effortlessly with our comprehensive REST and GraphQL APIs.",
    },
  ];
  ...
  return (
    <div style={styles.page}>
      ...
      <div
        style={{
          backgroundColor: tColor("color-surface-error-default"),
          color: tColor("color-text-error-default"),
          padding: "0.75rem",
          textAlign: "center",
          display: "flex",
          ...
          fontSize: "0.875rem",
          fontWeight: 600,
          borderBottom: `1px solid ${tColor("color-border-error-default")}`,
        }}
      >
        ...
        <div style={styles.container}>
          <div style={styles.nav}>
            ...
            <div style={{ display: "flex", gap: "2rem", alignItems: "center" }}>
              ...
              <ThemeToggle isDarkMode={isDarkMode} onChange={() => onToggleTheme()} />
        ...
        <div style={styles.container}>
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: "4rem" }}>
            <div style={{ flex: "1 1 500px", zIndex: 2 }}>
              ...
              >
                Build the future of{" "}
                <span style={{ color: tColor(`color-text-${primaryColorName}-default`) }}>
                  software
                </span>{" "}
                together.
              </h1>
              ...
              >
                Empower your team with the world's most flexible and scalable platform. Design,
      ...
      <section
        style={{
          backgroundColor: tColor("color-surface-subtle"),
          padding: "4rem 0",
          borderTop: `1px solid ${tColor("color-border-subtle")}`,
          borderBottom: `1px solid ${tColor("color-border-subtle")}`,
        }}
      >
        <div style={styles.container}>
        ...
        <div style={styles.container}>
          ...
          >
            ...
            >
              ...
              <span style={{ color: tColor(`color-text-${secondaryColorName}-default`) }}>
                scale
              </span>
              .
            </h2>
            ...
            >
              A comprehensive suite of tools designed to remove friction from your workflow and
                ...
                >
                  <div
                    style={{
                      ...
                      backgroundColor: isHighlight
                        ? tColor(`color-surface-${primaryColorName}-subtle`)
                        : tColor("color-surface-subtle"),
                      borderRadius: tRadius("lg"),
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                  ...
                  <p
                    style={{
                      fontSize: "1rem",
                      color: isHighlight
                        ? tColor(`color-text-${primaryColorName}-default`)
                        : tColor("color-text-description"),
                      lineHeight: 1.6,
                      margin: 0,
                    }}
                  >
      ...
      <section style={{ padding: "4rem 0", overflow: "hidden" }}>
        <div style={styles.container}>
          <div
            style={{
              backgroundColor: tColor(`color-base-${primaryColorName}-default`),
              borderRadius: tRadius("xl"),
              padding: "0",
              display: "flex",
              flexWrap: "wrap",
            ...
            >
              <h2
                style={{
                  fontSize: "2.5rem",
                  fontWeight: 800,
                  color: tColor(`color-text-${primaryColorName}-contrast`),
                  marginBottom: "1.5rem",
                  lineHeight: 1.2,
                }}
              >
              ...
              >
                Gain real-time insights with our advanced analytics engine. Make decisions faster,
                backed by beautiful, impossible-to-ignore data visualization.
              </p>
              <div>
            ...
            <div
              style={{
                ...
                backgroundColor: isDarkMode
                  ? tColor("color-neutral-900")
                  : tColor("color-neutral-25"),
                padding: "4rem",
                display: "flex",
                justifyContent: "center",
                alignItems: "center",
      ...
      <section style={{ padding: "8rem 0" }}>
        <div style={styles.container}>
          <div style={{ textAlign: "center", marginBottom: "4rem" }}>
            ...
            <p style={{ fontSize: "1.125rem", color: tColor("color-text-description") }}>
              Built perfectly on top of semantic UI tokens.
            </p>
          </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
                {[1, 2, 3, 4].map((depth) => (
                  ...
                  >
                    <div style={{ fontWeight: 600, color: tColor("color-text-default") }}>
                      Shadow {depth}
                    </div>
                    <div style={{ fontSize: "0.75rem", color: tColor("color-text-description") }}>
                      var(--theme-shadow-{depth})
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section style={{ padding: "8rem 0", backgroundColor: tColor("color-surface-subtle") }}>
        <div style={styles.container}>
          <div style={{ textAlign: "center", marginBottom: "5rem" }}>
            ...
            <p style={{ fontSize: "1.25rem", color: tColor("color-text-description") }}>
              No surprise fees. Just the features you need.
            </p>
          </div>
          ...
          >
            ...
            <div style={{ ...styles.card, flex: "1 1 350px", maxWidth: "450px" }}>
              ...
              <p style={{ color: tColor("color-text-description"), marginBottom: "2rem" }}>
            ...
            >
              <div
                style={{
                  ...
                  backgroundColor: tColor(`color-base-${secondaryColorName}-default`),
                  color: tColor(`color-text-${secondaryColorName}-contrast`),
                  padding: "0.25rem 1rem",
                  borderRadius: tRadius("full"),
                  fontWeight: 700,
                  fontSize: "0.875rem",
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: "0 0 2rem 0" }}>
                {[
                  ...
                  >
                    <ArrowRight
                      size={16}
                      color={tColor(`color-icon-${secondaryColorName}-default`)}
                    />
                    {item}
                  </li>
                ))}
              ...
              <div style={{ display: "flex", justifyContent: "center" }}>
                <Button variant="primary" color={secondaryColorName}>
                  Get Started
                </Button>
              </div>
            </div>
